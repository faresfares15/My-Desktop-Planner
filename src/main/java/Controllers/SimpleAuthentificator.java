...
public class SimpleAuthentificator implements Authentificator {
    ...
    @Override
    public UserSchema signUp(String username, String password, UsersDB usersDB) throws UniqueUsernameViolationException, UserNameNotProvidedException, PasswordNotProvidedException {
        ...
        return usersDB.addUser(new UserSchema(username, password));
    }
